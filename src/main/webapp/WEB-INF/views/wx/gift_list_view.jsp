...
<div class="content-view paper">
  <h4>${gift.giftName}德国巧克力 <span style="float:right;"><input name="number" type="text" min="1" class="qdone-numbers" value="1" style="width:60px; text-align:center;"></span></h4>
